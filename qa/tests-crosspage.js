...
suite('Cross-Page Tests', function(){
	...
	test('visiting the "request group rate" page dirctly should result in an empty referrer field', function(){
		browser.visit("http://localhost:3000/tours/request-group-rate", function(done){
